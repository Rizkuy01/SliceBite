...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Product Dashboard | SliceBite</title>
                ...
                $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                            <div class='d-flex'>
                            <button type='button' class='btn btn-info btn-sm me-2' data-bs-toggle='modal' data-bs-target='#detailsModal' data-id='" . $row["id"] . "'>Details</button>
            ...
            <div class="modal-body">
                <form id="addProductForm" action="add-product.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">(contoh: jika Rp20.000, ketik tanpa format, menjadi 20000)</small>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="productVariant" name="productVariant" required />
                    </div>
                    <div class="mb-3">
